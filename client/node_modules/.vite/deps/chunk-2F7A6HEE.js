...
var t, r, u, i, o, f, c, e, a, v, l2, m2, s, k2;
...
var R, w2, I, N, M, T2, V, z2, B3, H2, Z, Y, $, J, nn, tn, en, rn, un, on, cn, pn, mn, yn, gn, En, Rn;
var init_compat_module = __esm({
  "node_modules/preact/compat/dist/compat.module.js"() {
    ...
    w2 = "undefined" != typeof Symbol && Symbol.for && Symbol.for("react.forward_ref") || 3911;
    I = function(n, t2) {
      ...
      "string" == typeof n.type && function(n2) {
        ...
        for (var o2 in t2) {
          ...
          if (!("value" === o2 && "defaultValue" in t2 && null == i2 || Y && "children" === o2 && "noscript" === e2 || "class" === o2 || "className" === o2)) {
            ...
            "defaultValue" === o2 && "value" in t2 && null == t2.value ? o2 = "value" : "download" === o2 && true === i2 ? i2 = "" : "translate" === c2 && "no" === i2 ? i2 = false : "ondoubleclick" === c2 ? o2 = "ondblclick" : "onchange" !== c2 || "input" !== e2 && "textarea" !== e2 || $(t2.type) ? "onfocus" === c2 ? o2 = "onfocusin" : "onblur" === c2 ? o2 = "onfocusout" : H2.test(o2) ? o2 = c2 : -1 === e2.indexOf("-") && B3.test(o2) ? o2 = o2.replace(Z, "-$&").toLowerCase() : null === i2 && (i2 = void 0) : c2 = o2 = "oninput", "oninput" === c2 && u2[o2 = c2] && (o2 = "oninputCapture"), u2[o2] = i2;
          }
        }
    ...
    gn = _2;
    En = fn;
    Rn = { useState: h, useId: g, useReducer: p, useEffect: y, useLayoutEffect: _2, useInsertionEffect: gn, useTransition: Sn, useDeferredValue: bn, useSyncExternalStore: Cn, startTransition: _n, useRef: A, useImperativeHandle: F, useMemo: T, useCallback: q, useContext: x, useDebugValue: P, version: "17.0.2", Children: N, render: q2, hydrate: G2, unmountComponentAtNode: vn, createPortal: j2, createElement: _, createContext: G, createFactory: ln, cloneElement: hn, createRef: m, Fragment: k, isValidElement: fn, isElement: En, isFragment: an, isMemo: sn, findDOMNode: dn, Component: b, PureComponent: C2, memo: x2, forwardRef: k3, flushSync: mn, unstable_batchedUpdates: pn, StrictMode: yn, Suspense: L, SuspenseList: U, lazy: F2, __SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED: on };
  }
});
...
//# sourceMappingURL=chunk-2F7A6HEE.js.map
